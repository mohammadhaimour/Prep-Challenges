...
const LastWord = (str) => {
    ...
    let startIndex = str.lastIndexOf(" ") + 1;
    let endIndex = str.length;
    let lastword = str.slice(startIndex, endIndex);
    return lastword;
...
const replaceWords = (str) => {
    // write your code here
    let words = str.split(' ');
    let index_I = words.indexOf('I');
    let index_am = words.indexOf('am');
    let index_was = words.indexOf('was');

    if (index_I != -1) { words.splice(index_I, 1, "We"); }
    if (index_am != -1) { words.splice(index_am, 1, "are"); }
    if (index_was != -1) { words.splice(index_was, 1, "were"); }
